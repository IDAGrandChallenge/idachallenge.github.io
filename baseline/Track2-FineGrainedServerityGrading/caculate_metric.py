...
class CaculateMetric:
    ...
    def process_data(self, gt_img_dir, gt_txt_dir, pred_img_dir, pred_txt_dir, class_txt_dir, txt_shuffix, S=2):
        ...
        if S == 1:
            ...
            S1Dict['all'] = S1
            print("class" + " " * 5 + "Sloc" + " " * 5 +"0.5*Sscreen" + " " * 5 +"0.5*Sfine" + " " * 5 +"Scls" + " " * 5 + "Sscreen" + " " * 5 + "Strack1")
            print("all" + " " * 5 + f"{SlocDict['all']:.3f}" + " " * 5 + f"{SscreenDict['all']*0.5:.3f}"  +" " * 5 + f"{SfineDict['all']*0.5:.3f}" + " " * 5 + f"{SclsDict['all']:.3f}" + " " * 5 + f"{SscreenDict['all']:.3f}" + " " * 5 + f"{S1:.3f}")
            ...
            for cls_idx in self.classes_index:
                ...
                print(classes_list[cls_idx] + " " * 3 + f"{cls_sloc:.3f}" + " " * 5 + f"{cls_screen*0.5:.3f}" + " " * 5 + f"{cls_sfine*0.5:.3f}"  + " " * 5 + f"{cls_scls:.3f}"+ " " * 5 + f"{cls_screen:.3f}" + " " * 5 + f"{cls_s1:.3f}")
            return S1Dict
...
if __name__ == '__main__':
    gt_img_dir = "/home/data1/images/test/"
    gt_txt_dir = "/home/data1/test_gradng/defects grading/"
    pt_img_dir = "/home/data1/result/predict/"
    pt_txt_dir = "/home/data1/result/predict_grading/defects grading/"
    cls_txt_dir = "/home/shared/data/IDA/Grading/defect_list.txt"
    txt_shuffix = '.json'
    cm = CaculateMetric()
